...
public class AWS_DDB_Empleados {
    ...
    public static void Create(DynamoDbClient dynamoDbClient, Empleado empleado) {
        try {
            ...
            Map<String, AttributeValue> item = Map.of("EmpleadoID", empleado.getEmpleadoID(), "Apellido", empleado.getApellido(),
                    "Cargo", empleado.getCargo(), "Direccion", empleado.getDireccion(),
    ...
    public static void Delete(DynamoDbClient dynamoDbClient, String empleadoID) {
        ...
        DeleteItemRequest deleteItemRequest = DeleteItemRequest.builder().tableName("Empleados").key(keyToDelete).build();
